"""Django settings for WestClothes project.
...
JAZZMIN_SETTINGS = {
    "site_title": "WestClothes Admin",
    "site_header": "WestClothes",
    "site_brand": "WestClothes Admin Panel",
    "welcome_sign": "WestClothes boshqaruv paneliga xush kelibsiz",
    "copyright": "WestClothes",
    "search_model": "ProductsApp.Product",
    "user_avatar": None,
    "topmenu_links": [
        {"name": "Dashboard", "url": "admin:index", "permissions": ["auth.view_user"]},
        {"name": "Products", "url": "admin:ProductsApp_product_changelist"},
        {"name": "Categories", "url": "admin:ProductsApp_category_changelist"},
    ],
    "show_sidebar": True,
...
JAZZMIN_UI_TWEAKS = {
    ...
    "navbar_text": "text-dark",
    "navbar_text_small_text": False,
...
# Media (uploaded files: product photos)
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'

# Лимит загружаемых файлов в форму (до 6 фото × ~10 МБ)
